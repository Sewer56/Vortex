 ...
 */
declare const addDialog: ComplexActionCreator6<
  string,
  string,
  string,
  IDialogContent,
 ...
 */
declare const addDiscoveredGame: ComplexActionCreator2<
  string,
  IDiscoveryResult,
  {
    id: string;
 ...
 */
declare const addDiscoveredTool: ComplexActionCreator4<
  string,
  string,
  IDiscoveredTool,
  boolean,
 ...
 * in the download.
 */
declare const addLocalDownload: ComplexActionCreator4<
  string,
  string,
  string,
  number,
...
): (dispatch: any) => Promise<void> | Promise_2<void>;
...
declare type ArchiveHandlerCreator = (
  fileName: string,
  options: IArchiveOptions,
) => Promise_2<IArchiveHandler>;
 ...
 */
declare type AttributeExtractor = (
  modInfo: any,
  modPath: string,
) => PromiseLike<{
  [key: string]: any;
...
declare const clearDialog: ComplexActionCreator1<
  string,
  {
    instanceId: string;
  },
...
declare const clearDiscoveredGame: ComplexActionCreator1<
  string,
  {
    id: string;
  },
...
declare class ClickPopover extends React_2.Component<
  ClickPopoverProps,
  {
    open: boolean;
  }
...
declare const collapseGroup: reduxAct.ComplexActionCreator3<
  string,
  string,
  boolean,
  {
 ...
 */
declare type CollectionModStatus =
  | "pending"
  | "downloading"
  | "downloaded"
  | "installing"
 ...
 * @template S
 */
export declare class ComponentEx<P, S extends object> extends React_2.Component<
...
declare class Debouncer extends GenericDebouncer<
  number,
...
declare type DialogContentItem =
  | "htmlFile"
  | "htmlText"
  | "text"
  | "message"
 ...
 */
declare const displayGroup: ComplexActionCreator2<
  string,
  string,
  {
    groupId: string;
 ...
 */
export declare class Dropdown extends React_2.Component<
  IProps,
  {
    up: boolean;
  }
...
declare const enabledModCountForProfile: ParametricSelector<IState, string, number> & {
  ...
  dependencies: [
    ParametricSelector<IState, string, IModTable>,
    ParametricSelector<IState, string, IProfile>,
  ];
  recomputations: () => number;
  resetRecomputations: () => number;
} & {
  getMatchingSelector: (
    ...
    [ParametricSelector<IState, string, IModTable>, ParametricSelector<IState, string, IProfile>]
  >;
  removeMatchingSelector: (state: IState, props: string, ...args: any[]) => void;
  clearCache: () => void;
  cache: ICacheObject;
...
declare const endDialog: ComplexActionCreator1<
  string,
  {
    instanceId: string;
  },
...
declare type ExportType = IContextMenuProps &
  IActionControlProps &
  IExtensibleProps &
  React_2.HTMLAttributes<any>;

declare type ExportType_2 = IBaseProps &
  IActionControlProps &
  IExtensibleProps &
  React_2.HTMLAttributes<any>;
...
declare type ExportType_4 = IBaseProps_6 &
  IActionControlProps &
  IExtensibleProps &
  React_2.HTMLAttributes<any>;
 ...
 */
declare const finalizingDownload: ComplexActionCreator1<
  string,
  {
    id: string;
  },
...
declare const finalizingProgress: ComplexActionCreator2<
  string,
  number,
  {
    id: string;
 ...
 */
declare const finishDownload: ComplexActionCreator3<
  string,
...
declare const gameById: ParametricSelector<IState, string, IGameStored> & {
  ...
  dependencies: [
    ParametricSelector<IState, string, IGameStored[]>,
    ParametricSelector<IState, string, string>,
  ];
  recomputations: () => number;
  resetRecomputations: () => number;
  ...
  getMatchingSelector: (
    ...
    [ParametricSelector<IState, string, IGameStored[]>, ParametricSelector<IState, string, string>]
  >;
  removeMatchingSelector: (state: IState, props: string, ...args: any[]) => void;
  clearCache: () => void;
  cache: ICacheObject;
...
declare type GameVersionProviderFunc = (
  game: IGame,
  discovery: IDiscoveryResult,
) => PromiseLike<string>;

declare type GameVersionProviderTest = (
  game: IGame,
  discovery: IDiscoveryResult,
) => PromiseLike<boolean>;
...
declare interface IExtensionApi {
  ...
  withPrePost: <T>(
    eventName: string,
    callback: (...args: any[]) => Promise_2<T>,
  ) => (...args: any[]) => Promise_2<T>;
  /**
...
declare interface IExtensionApiExtension
  ...
  showOverlay?: (
    id: string,
    title: string,
    content: string | React_2.ComponentType<any>,
    pos?: IPosition,
...
declare interface IExtensionContext {
  ...
  registerPreview?: (
    priority: number,
    handler: (files: IPreviewFile[], allowPick: boolean) => Promise_2<IPreviewFile>,
  ) => void;
  /**
...
declare interface IGameLoadOrderEntry {
  ...
  ) => Promise_3<ILoadOrderDisplayItem[]>;
...
declare type IImageProps = React_2.DetailedHTMLProps<
 ...
 */
declare const initDownload: ComplexActionCreator4<
  string,
  string[],
  IDictionary,
  string[],
...
declare const installPathForGame: ParametricSelector<IState, string, string> & {
  ...
  getMatchingSelector: (
    ...
    [ParametricSelector<IState, string, string>, ParametricSelector<IState, string, string>]
  >;
  removeMatchingSelector: (state: IState, props: string, ...args: any[]) => void;
  clearCache: () => void;
  cache: ICacheObject;
 ...
 */
declare interface IReducerSpec<
  T = {
    [key: string]: any;
  },
> {
...
declare interface IRegisterRepositoryLookup {
  (
    ...
    callback: (id: IModRepoId) => Promise_2<IModLookupResult[]>,
  ): any;
}
...
declare interface IWebView extends React_2.DetailedHTMLProps<
  React_2.WebViewHTMLAttributes<HTMLWebViewElement>,
  HTMLWebViewElement
> {
  src?: string;
  style?: any;
...
declare const loadCategories: reduxAct.ComplexActionCreator2<
  string,
  ICategoryDictionary,
  {
    gameId: string;
...
declare const MainPageBody: React_3.ForwardRefExoticComponent<
  React_3.HTMLAttributes<HTMLDivElement> & React_3.RefAttributes<HTMLDivElement>
>;

declare const MainPageHeader: FC<IProps_11>;

declare const MainPageInner: React_3.ForwardRefExoticComponent<
  IBaseProps_12 & React_3.RefAttributes<HTMLDivElement>
>;
...
declare const mergeDownloadModInfo: ComplexActionCreator2<
  string,
  any,
  {
    id: string;
...
declare const needToDeployForGame: ParametricSelector<IState, string, boolean> & {
  ...
  dependencies: [
    ParametricSelector<IState, string, INeedToDeployMap>,
    ParametricSelector<IState, string, string>,
  ];
  recomputations: () => number;
  resetRecomputations: () => number;
 ...
 */
export declare class Overlay extends React_2.Component<
  IProps_6,
  {
    placement: string;
  }
 ...
 * @extends {React.Component<any, { placement: string }>}
 */
export declare class OverlayTrigger extends React_2.Component<
  IProps_7,
  {
    placement: string;
  }
 ...
 */
declare const pauseDownload: ComplexActionCreator3<
  string,
  boolean,
  IChunk[],
  {
...
export declare class PortalMenu extends React_2.Component<
  IPortalMenuProps,
  {
    x: number;
    y: number;
...
export declare class PureComponentEx<P, S extends object> extends React_2.PureComponent<
  P & Partial<WithTranslation>,
  S
> {
  static contextTypes: React_2.ValidationMap<any>;
...
declare type RegisterAction = (
  group: string,
  position: number,
  iconOrComponent: string | React_2.ComponentType<any>,
  options: IActionOptions,
...
declare type RegisterBanner = (
  group: string,
  component: React_2.ComponentType<any>,
  options: IBannerOptions,
) => void;

declare type RegisterControlWrapper = (
  group: string,
  priority: number,
  wrapper: React_2.ComponentType<any>,
) => void;
 ...
 */
declare type RegisterDashlet = (
  title: string,
  width: 1 | 2 | 3,
  height: 1 | 2 | 3 | 4 | 5 | 6,
  position: number,
  component: React_2.ComponentClass<any> | React_2.FunctionComponent<any>,
  isVisible: (state: any) => boolean,
  props: PropsCallback,
  options: IDashletOptions,
) => void;

declare type RegisterDialog = (
  id: string,
  element: React_2.ComponentType<any>,
  props?: PropsCallback,
) => void;

declare type RegisterFooter = (
  id: string,
  element: React_2.ComponentClass<any>,
  props?: PropsCallback,
) => void;

declare type RegisterMainPage = (
  icon: string,
  title: string,
  element: React_2.ComponentType<any>,
...
declare type RegisterSettings = (
  title: string,
  element: React_2.ComponentClass<any> | React_2.StatelessComponent<any>,
  props?: PropsCallback,
  visible?: () => boolean,
  priority?: number,
) => void;

declare type RegisterToDo = (
  id: string,
  type: ToDoType,
  props: (state: any) => any,
...
declare const removeCategory: reduxAct.ComplexActionCreator2<
  string,
  string,
  {
    gameId: string;
 ...
 */
declare const removeDownload: ComplexActionCreator1<
  string,
  {
    id: string;
  },
...
declare const removeDownloadSilent: ComplexActionCreator1<
  string,
  {
    id: string;
  },
...
declare const renameCategory: reduxAct.ComplexActionCreator3<
  string,
  string,
  string,
  {
...
declare const setAttributeFilter: reduxAct.ComplexActionCreator3<
  string,
  string,
  any,
  {
...
declare const setAttributeSort: reduxAct.ComplexActionCreator3<
  string,
  string,
  SortDirection,
  {
...
declare const setAttributeVisible: reduxAct.ComplexActionCreator3<
  string,
  string,
  boolean,
  {
...
declare const setCategory: reduxAct.ComplexActionCreator3<
  string,
  string,
  ICategory,
  {
...
declare const setCategoryOrder: reduxAct.ComplexActionCreator2<
  string,
  string[],
  {
    gameId: string;
...
declare const setCollapsedGroups: reduxAct.ComplexActionCreator2<
  string,
  string[],
  {
    tableId: string;
...
declare const setCompatibleGames: ComplexActionCreator2<
  string,
  string[],
  {
    id: string;
...
declare const setDialogState: ComplexActionCreator2<
  IInstallerState,
  string,
  {
...
declare const setDialogVisible: ComplexActionCreator1<
  string,
  {
    dialogId: string;
  },
 ...
 */
declare const setDownloadFilePath: ComplexActionCreator2<
  string,
  string,
  {
    id: string;
...
declare const setDownloadHash: ComplexActionCreator2<
  string,
  string,
  {
    id: string;
...
declare const setDownloadHashByFile: ComplexActionCreator3<
  string,
  string,
  number,
  {
...
declare const setDownloadInstalled: ComplexActionCreator3<
  string,
  string,
  string,
  {
...
declare const setDownloadInterrupted: ComplexActionCreator2<
  string,
  number,
  {
    id: string;
...
declare const setDownloadModInfo: ComplexActionCreator3<
  string,
  string,
  any,
  {
 ...
 */
declare const setDownloadPausable: ComplexActionCreator2<
  string,
  boolean,
  {
    id: string;
 ...
 */
declare const setDownloadSpeed: ComplexActionCreator1<
  unknown,
  unknown,
  {
    forward: boolean;
...
declare const setDownloadTime: ComplexActionCreator2<
  string,
  number,
  {
    id: string;
...
declare const setExtensionEnabled: reduxAct.ComplexActionCreator2<
  string,
  boolean,
  {
    extensionId: string;
...
declare const setExtensionEndorsed: reduxAct.ComplexActionCreator2<
  string,
  string,
  {
    extensionId: string;
...
declare const setExtensionVersion: reduxAct.ComplexActionCreator2<
  string,
  string,
  {
    extensionId: string;
 ...
 */
declare const setGameHidden: ComplexActionCreator2<
  string,
  boolean,
  {
    gameId: string;
 ...
 */
declare const setGameParameters: ComplexActionCreator2<
  string,
  any,
  {
    gameId: string;
 ...
 */
declare const setGamePath: ComplexActionCreator4<
  string,
  string,
  string,
  string,
...
declare const setGroupingAttribute: reduxAct.ComplexActionCreator2<
  string,
  string,
  {
    tableId: string;
...
declare const setInstallType: reduxAct.ComplexActionCreator1<
  VortexInstallType,
  VortexInstallType,
  {}
>;
 ...
 */
declare const setLoadOrder: ComplexActionCreator2<
  string,
  any[],
  {
    id: string;
...
declare const setOpenMainPage: ComplexActionCreator2<
  string,
  boolean,
  {
    page: string;
...
declare const setPickerLayout: ComplexActionCreator1<
  "list" | "small" | "large",
  {
...
declare const setPrimaryTool: ComplexActionCreator2<
  string,
  string,
  {
    gameId: string;
...
declare const setProgress: ComplexActionCreator4<
  string,
  string,
  string,
  number,
...
declare const setSettingsPage: ComplexActionCreator1<
  string,
  {
    pageId: string;
  },
...
declare const setToolOrder: ComplexActionCreator2<
  string,
  string[],
  {
    gameId: string;
...
declare const setToolPid: ComplexActionCreator3<
  string,
  number,
  boolean,
  {
...
declare const setToolPinned: ComplexActionCreator3<
  string,
  string,
  boolean,
  {
...
declare const setToolRunning: ComplexActionCreator3<
  string,
  number,
  boolean,
  {
...
declare const setToolStopped: ComplexActionCreator1<
  string,
  {
    exePath: string;
  },
...
declare const setToolValid: ComplexActionCreator3<
  string,
  string,
  boolean,
  {
 ...
 */
declare const setToolVisible: ComplexActionCreator3<
  string,
  string,
  boolean,
  {
...
declare const setUIBlocker: ComplexActionCreator4<
  string,
  string,
  string,
  boolean,
...
declare function showDialog(
  ...
  actions: DialogActions,
  inId?: string,
): (dispatch: any) => Promise_2<IDialogResult>;
...
declare const startActivity: ComplexActionCreator2<
  string,
  string,
  {
    group: string;
...
declare const startDialog: ComplexActionCreator2<
  IInstallerInfoState,
  string,
  {
 ...
 */
declare const startDownload: ComplexActionCreator1<
  string,
  {
    id: string;
  },
...
declare const stopActivity: ComplexActionCreator2<
  string,
  string,
  {
    group: string;
 ...
 */
declare const suppressNotification: ComplexActionCreator2<
  string,
  boolean,
  {
    id: string;
...
declare type TrackedFunction<T> = (
  setAttribute: SetAttribute,
  setError: SetError,
) => Promise_2<T> | Promise<T>;
...
declare const updateCategories: reduxAct.ComplexActionCreator2<
  string,
  ICategoryDictionary,
  {
    gameId: string;
...
declare const updateNotification: ComplexActionCreator3<
  string,
  number,
  string,
  {
...
export declare class ZoomableImage extends React_2.Component<
  IZoomableImageProps,
  {
    showOverlay: boolean;
  }
